...
const HeswapPair = artifacts.require('HeswapPair');
...
contract('MasterChef', ([alice, bob, carol, dev, refFeeAddr, feeAddr, minter]) => {
    beforeEach(async () => {
        ...
        this.bsw = await HSWToken.new({ from: minter });
        ...
        this.factory = await HeswapFactory.new(minter, { from: minter });
        ...
        this.router = await HeswapRouter02.new(this.factory.address, this.wbnb.address, { from: minter });
